...
libcrypto_sources = [
  ...
  'generated-config/archs/BSD-x86/no-asm/providers/common/der/der_sm2_gen.c',
  'generated-config/archs/BSD-x86/no-asm/providers/common/der/der_digests_gen.c',
  'generated-config/archs/BSD-x86/no-asm/providers/common/der/der_dsa_gen.c',
  'generated-config/archs/BSD-x86/no-asm/providers/common/der/der_ec_gen.c',
  'generated-config/archs/BSD-x86/no-asm/providers/common/der/der_ecx_gen.c',
  'generated-config/archs/BSD-x86/no-asm/providers/common/der/der_rsa_gen.c',
  'generated-config/archs/BSD-x86/no-asm/providers/common/der/der_wrap_gen.c',
]
libssl_sources = [
  'ssl/bio_ssl.c',
  'ssl/d1_lib.c',
...
openssl_include_directories = [
  'generated-config/archs/BSD-x86/no-asm',
  'generated-config/archs/BSD-x86/no-asm/include',
  'generated-config/archs/BSD-x86/no-asm/crypto',
  'generated-config/archs/BSD-x86/no-asm/providers/common/include',
]
...
openssl_cli_sources = [
  ...
  'apps/pkeyutl.c',
  'apps/prime.c',
  'generated-config/archs/BSD-x86/no-asm/apps/progs.c',
  'apps/rand.c',
  'apps/rehash.c',
  'apps/req.c',
  'apps/rsa.c',
